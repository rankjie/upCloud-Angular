...
Controllers['DashBoardController'] = function($scope, $http, $location, myData, $routeParams) {
  ...
  scope.setFiles = function(element) {
    var autoUpload, file, _i, _len, _ref;
    if (element.files.length > 0) {
      ...
      return console.log('no files were selected.');
    }
  };
  uploadFile = function() {
    var nextFile;
  ...
  uploadComplete = function(evt) {
    ...
    return $http.post(baseURL + '/api/files/done', evt.target.response).success(function(res) {
      var delay;
      console.log(res);
